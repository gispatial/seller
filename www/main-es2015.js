...
const routes = [
    ...
    {
        path: 'phone-number',
        loadChildren: () => __webpack_require__.e(/*! import() | phone-number-phone-number-module */ "phone-number-phone-number-module").then(__webpack_require__.bind(null, /*! ./phone-number/phone-number.module */ "./src/app/phone-number/phone-number.module.ts")).then(m => m.PhoneNumberPageModule)
    },
    {
        path: 'register',
    ...
    {
        path: 'order-info',
        loadChildren: () => Promise.all(/*! import() | order-info-order-info-module */[__webpack_require__.e("default~chat-customer-chat-customer-module~order-info-order-info-module"), __webpack_require__.e("order-info-order-info-module")]).then(__webpack_require__.bind(null, /*! ./order-info/order-info.module */ "./src/app/order-info/order-info.module.ts")).then(m => m.OrderInfoPageModule)
    },
    {
        path: 'chat-customer',
        loadChildren: () => Promise.all(/*! import() | chat-customer-chat-customer-module */[__webpack_require__.e("default~chat-customer-chat-customer-module~order-info-order-info-module"), __webpack_require__.e("chat-customer-chat-customer-module")]).then(__webpack_require__.bind(null, /*! ./chat-customer/chat-customer.module */ "./src/app/chat-customer/chat-customer.module.ts")).then(m => m.ChatCustomerPageModule)
    },
    {
        path: 'items',
    ...
    {
        path: 'add-product',
        loadChildren: () => __webpack_require__.e(/*! import() | add-product-add-product-module */ "add-product-add-product-module").then(__webpack_require__.bind(null, /*! ./add-product/add-product.module */ "./src/app/add-product/add-product.module.ts")).then(m => m.AddProductPageModule)
    },
    {
        path: 'edit-product',
        loadChildren: () => __webpack_require__.e(/*! import() | edit-product-edit-product-module */ "edit-product-edit-product-module").then(__webpack_require__.bind(null, /*! ./edit-product/edit-product.module */ "./src/app/edit-product/edit-product.module.ts")).then(m => m.EditProductPageModule)
    },
    {
        path: 'my-account',
        loadChildren: () => Promise.all(/*! import() | my-account-my-account-module */[__webpack_require__.e("common"), __webpack_require__.e("my-account-my-account-module")]).then(__webpack_require__.bind(null, /*! ./my-account/my-account.module */ "./src/app/my-account/my-account.module.ts")).then(m => m.MyAccountPageModule)
    },
    {
        path: 'store-profile',
        loadChildren: () => __webpack_require__.e(/*! import() | store-profile-store-profile-module */ "store-profile-store-profile-module").then(__webpack_require__.bind(null, /*! ./store-profile/store-profile.module */ "./src/app/store-profile/store-profile.module.ts")).then(m => m.StoreProfilePageModule)
    },
    {
        path: 'set-location',
        loadChildren: () => __webpack_require__.e(/*! import() | set-location-set-location-module */ "set-location-set-location-module").then(__webpack_require__.bind(null, /*! ./set-location/set-location.module */ "./src/app/set-location/set-location.module.ts")).then(m => m.SetLocationPageModule)
    },
    {
        path: 'insight',
        loadChildren: () => __webpack_require__.e(/*! import() | insight-insight-module */ "insight-insight-module").then(__webpack_require__.bind(null, /*! ./insight/insight.module */ "./src/app/insight/insight.module.ts")).then(m => m.InsightPageModule)
    },
    {
        path: 'wallet',
    ...
    {
        path: 'buyappalert',
        loadChildren: () => Promise.all(/*! import() | buyappalert-buyappalert-module */[__webpack_require__.e("common"), __webpack_require__.e("buyappalert-buyappalert-module")]).then(__webpack_require__.bind(null, /*! ./buyappalert/buyappalert.module */ "./src/app/buyappalert/buyappalert.module.ts")).then(m => m.BuyappalertPageModule)
    },
    {
        path: 'reviews',
    ...
    {
        path: 'vt-popup',
        loadChildren: () => __webpack_require__.e(/*! import() | vt-popup-vt-popup-module */ "vt-popup-vt-popup-module").then(__webpack_require__.bind(null, /*! ./vt-popup/vt-popup.module */ "./src/app/vt-popup/vt-popup.module.ts")).then(m => m.VtPopupPageModule)
    }
];
...
/* harmony import */ var _vt_popup_vt_popup_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./vt-popup/vt-popup.page */ "./src/app/vt-popup/vt-popup.page.ts");
...
let AppComponent = class AppComponent {
    ...
    globalize(languagePriority) {
        ...
        this.translate.use(languagePriority && languagePriority.length
            ? languagePriority
            : defaultLangCode);
        this.setDirectionAccordingly(languagePriority && languagePriority.length
            ? languagePriority
            : defaultLangCode);
    }
...
module.exports = __webpack_require__(/*! /Users/crocslut/Desktop/Git/ionic-delyva/delivoo-seller-ionic5-master/src/main.ts */"./src/main.ts");
